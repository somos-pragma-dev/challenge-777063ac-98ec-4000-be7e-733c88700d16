...
| Patron arquitectonico | capas estándar (controladores, servicios, repositorio) |
...
- **Fase 1 — Definición de endpoints y modelos de datos**: Definición de endpoints y modelos de datos para la API REST.
- **Fase 2 — Implementación de endpoints y lógica de negocio**: Implementación de endpoints y lógica de negocio para la API REST.
- **Fase 3 — Pruebas y optimización**: Pruebas unitarias y de integración, y optimización de rendimiento para la API REST.
...
- El patron es **capas estándar (controladores, servicios, repositorio)**: los contratos (interfaces, puertos) los define la capa interna y los implementa la externa, nunca al revés.
